...
{
    [RoutePrefix("Api/Product")]//This is Route prefix filter which will be added in the URL for this specific controller  
    [Authorize]//This filter redirects the request to the provider class first request will authenticate if authentication successful than it will come to here  
